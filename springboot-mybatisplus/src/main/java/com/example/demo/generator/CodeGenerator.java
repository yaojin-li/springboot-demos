...
public class CodeGenerator {
     ...
     * 数据库 URL
     */
    public static final String JDBC_MYSQL_URL = "jdbc:mysql://localhost:3306/test?useUnicode=true&characterEncoding=UTF8&useSSL=false&serverTimezone=Asia/Shanghai";
